...
namespace ConsoleApp2
{
    class Program
    {
        ...
        {
            ChessPawn Pawn1B = new ChessPawn(3, 7, false);
            ChessPawn Pawn2B = new ChessPawn(1, 5, false);
            ChessKing KingB = new ChessKing(1, 3, false);
            ChessRook Rook1B = new ChessRook(2, 3, false);

            ChessQueen QueenW = new ChessQueen(7, 2, true);
            ChessKing KingW = new ChessKing(8, 5, true);
            ChessHorse Horse1W = new ChessHorse(8, 2, true);
            ChessElephant Elephant1W = new ChessElephant(2, 5, true);
